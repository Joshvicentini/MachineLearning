...
public class DecisionTree extends Algorithm<List<Point>> {

	private static final long serialVersionUID = 1L;

	@Override
	public void execute(List<Point> source, Parameters parameters) {
		this.report.addReport("Executing method Decision Tree\n");
		...
		this.report.addReport("Finishing method Decision Tree...\n");
	}
